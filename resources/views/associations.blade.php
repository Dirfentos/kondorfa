        ...
        <div class="card mb-3">
            <div class="row g-0">
              <div class="col-md-4 d-flex align-items-center">
                <img src="images/tuzolto1.jpg" class="img-fluid rounded-start" style="height: 200px" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
          ...
          <div class="card mb-3" >
            <div class="row g-0">
              <div class="col-md-4 d-flex align-items-center">
                <img src="images/foci.png" class="img-fluid rounded-start" style="height: 200px; margin-left: 30px;" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
          ...
          <div class="card mb-3" >
            <div class="row g-0">
              <div class="col-md-4 d-flex align-items-center">
                <img src="images/civil1.jpg" class="img-fluid rounded-start" style="height: 200px; margin-left: 0px;" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
